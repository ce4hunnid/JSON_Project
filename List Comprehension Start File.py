...
new_list = [i**2 for i in old_list] #expression, iteration, no condition
print(new_list)                     #This creates exact same list
...
x = [i for i in range(10)] #iteration and condition
print(x)
...
#numbers = [int(x) for x in string if x.isalpha()]
#print(numbers)
